...
DELETE FROM `equipo`;
INSERT INTO `equipo` (`id`, `nombre`, `activo`, `fechaAlta`, `fechaModifcacion`) VALUES
...
DELETE FROM `jugador`;
INSERT INTO `jugador` (`id`, `idEquipo`, `nombre`, `numero`, `activo`, `fechaAlta`, `fechaModificacion`) VALUES
...
INSERT INTO `producto` (`id`, `descripcion`, `idEquipo`, `idJugador`, `numero`, `precio`, `stock`, `numeroLikes`) VALUES
